...
public class UploadActivity extends AppCompatActivity {
    ...
    /*
    Privacy level dictates who can see post
        0 = Friends
        1 = Only user
        2 = Public
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Use the image picker from github to upload imgages

        addImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ImagePicker.create(UploadActivity.this).folderMode(true)
                        .single().start();
            }
        });
    ...
    private void uploadPost() {
        ...
        if(status.trim().length()>0 || isImageSelected) {
            ...
            call.enqueue(new Callback<Integer>() {
                ...
                public void onResponse(Call<Integer> call, Response<Integer> response) {
                    ...
                    if(response.body() != null && response.body() == 1) {
                        ...
                        Toast.makeText(UploadActivity.this, "Post successful", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(UploadActivity.this, "Write Post", Toast.LENGTH_SHORT).show();
        }
    }
